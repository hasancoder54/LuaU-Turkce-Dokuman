...
**dosya sistemi** işlevleri, yürütücünün dizininde genellikle *çalışma alanı* olarak adlandırılan, belirlenmiş bir klasöre okuma ve yazma erişimi sağlar.
...
*Çalışma alanındaki* her dosya ve klasörü yazdırır.
